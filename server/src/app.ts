...
import { inventoryRouter } from "./modules/availability/inventory.routes.js";
...
import { paymentMethodRouter } from "./modules/payments/payment-method.routes.js";
...
app.use("/api/v1/me", favoriteRouter);
